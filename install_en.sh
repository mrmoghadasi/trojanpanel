...
main() {
  ...
  echo_content yellow "4. Install MariaDB"
  echo_content yellow "5. Install Redis"
  echo_content green "\n=============================================== =================="
  echo_content yellow "6. Update Trojan Panel"
  echo_content yellow "7. Update Trojan Panel Core"
  echo_content green "\n=============================================== =================="
  echo_content yellow "8. Uninstall Trojan Panel"
  echo_content yellow "9. Uninstall Trojan Panel Core"
  echo_content yellow "10. Uninstall Caddy TLS"
  echo_content yellow "11. Uninstall MariaDB"
  echo_content yellow "12. Uninstall Redis"
  echo_content yellow "13. Uninstall all Trojan Panel related applications"
  echo_content green "\n=============================================== =================="
  echo_content yellow "14. Modify Trojan Panel front-end port"
  echo_content yellow "15. Refresh Redis cache"
  echo_content green "\n=============================================== =================="
